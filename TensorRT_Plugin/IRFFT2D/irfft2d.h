#ifndef LIUXUAN_IRFFT_2D_PLUGIN_H
#define LIUXUAN_IRFFT_2D_PLUGIN_H
...
namespace plugin
{
class IRFFT2D: public nvinfer1::IPluginV2DynamicExt
{
public:
    IRFFT2D(const std::string name);
    ~IRFFT2D() override = default;
...
class IRFFT2DCreator : public nvinfer1::IPluginCreator
{
public:
    IRFFT2DCreator();
    ~IRFFT2DCreator() override = default;
